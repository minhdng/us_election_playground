...
# Question 1: Republican vs Democratics: which party has a more educated voting base?
...
*Table: Respondant party identification for each education level *
```{r, echo=FALSE}
...
![*source: tmz.com*](../fig/buildwall.jpg)
